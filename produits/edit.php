...
<div class="container-fluid">
    <div class="form-page-header">
        <div>
            ...
            <p class="form-page-subtitle mb-0">Gestion du catalogue produits</p>
        </div>
        <a href="<?= $produitsListUrl ?>" class="btn btn-cancel">
    ...
    <form method="post" enctype="multipart/form-data" class="card form-card" id="formProduit">
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label class="form-label required"><i class="bi bi-upc-scan"></i> Code produit</label>
                    <input type="text" name="code_produit" class="form-control" required
                           value="<?= htmlspecialchars($code_produit) ?>">
                </div>

                <div class="col-md-5">
                    <label class="form-label required"><i class="bi bi-tag"></i> Désignation</label>
