...
<div class="container-fluid">
    <div class="form-page-header">
        <div>
            ...
            <p class="form-page-subtitle mb-0">Gestion des informations client</p>
        </div>
        <a href="<?= $clientsListUrl ?>" class="btn btn-cancel">
    ...
    <form method="post" class="card form-card" id="formClient">
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label required"><i class="bi bi-person"></i> Nom du client</label>
                    <input type="text" name="nom" class="form-control" required
                           value="<?= htmlspecialchars($nom) ?>">
                </div>

                <div class="col-md-3">
                    <label class="form-label required"><i class="bi bi-tag"></i> Type</label>
                ...
                <div class="col-md-3">
                    <label class="form-label required"><i class="bi bi-flag"></i> Statut</label>
                ...
                <div class="col-md-4">
                    <label class="form-label"><i class="bi bi-diagram-3"></i> Source (Facebook, WhatsApp...)</label>
