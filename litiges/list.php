...
<div class="container-fluid">
    <div class="list-page-header d-flex justify-content-between align-items-center">
        <h1 class="list-page-title h3">
            ...
            Retours & litiges clients
            <span class="count-badge ms-2"><?= count($litiges) ?></span>
        </h1>
        <?php if ($peutEditer): ?>
            <a href="<?= url_for('litiges/edit.php') ?>" class="btn btn-primary btn-add-new">
        ...
        <div class="card-body">
            <form method="get" class="row g-3 align-items-end">
                ...
                <div class="col-12 d-flex gap-2 mt-2">
                    ...
                    <a href="<?= url_for('litiges/list.php') ?>" class="btn btn-outline-secondary btn-filter">
                        Réinitialiser
                    </a>
                </div>
            </form>
