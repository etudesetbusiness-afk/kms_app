<?php
/**
 * Configuration Email - KMS Gestion (Version Bluehost Production)
 * 
 * INSTRUCTIONS :
 * Copiez ce fichier vers lib/email_config.php sur le serveur Bluehost
 * 
 * @version 1.0
 * @date 2025-12-20
 */
...
// ============================================================
// CONFIGURATION EMAIL SMTP - BLUEHOST PRODUCTION
// ============================================================

define('EMAIL_SMTP_ENABLED', true);  // true = SMTP, false = mail()

// Configuration SMTP Bluehost
// Sur Bluehost mutualisé, utilisez votre domaine ou 'localhost'
...
// ⚠️ MODIFIEZ CES VALEURS avec votre email créé dans cPanel Bluehost
// Créez un email dans cPanel > Email Accounts (ex: noreply@kennemulti-services.com)
define('EMAIL_SMTP_USERNAME', 'cm@kennemulti-services.com');
define('EMAIL_SMTP_PASSWORD', 'Kenne@#11');  // Mot de passe de l'email

// Expéditeur
define('EMAIL_FROM_ADDRESS', 'cm@kennemulti-services.com');
