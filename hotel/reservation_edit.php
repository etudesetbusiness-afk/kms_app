        ...
        <div class="card-body">
            <form method="post">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <label class="form-label required"><i class="bi bi-person"></i> Nombre de nuits</label>
                    ...
                    <div class="col-md-3">
                        <label class="form-label"><i class="bi bi-currency-dollar"></i> Montant total (estimé)</label>
