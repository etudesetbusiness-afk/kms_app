...
<div class="container-fluid">
    <div class="form-page-header">
        <div>
            ...
            <p class="form-page-subtitle mb-0">Gestion des prospects digitaux</p>
        </div>
        <a href="<?= url_for('digital/leads_list.php') ?>" class="btn btn-cancel">
        ...
        <div class="col-lg-8">
            <div class="card form-card">
                <div class="card-header">
                    <i class="bi bi-person-badge"></i> Informations du lead
                </div>
                <div class="card-body">
                    <form method="post" id="formLead">
                        ...
                        <div class="row g-3">
                            <!-- Date du lead -->
                            <div class="col-md-4">
                                <label class="form-label required"><i class="bi bi-calendar"></i> Date du lead</label>
                            ...
                            <!-- Nom du prospect -->
                            <div class="col-md-6">
                                <label class="form-label required"><i class="bi bi-person"></i> Nom du prospect <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <label class="form-label"><i class="bi bi-calendar"></i> Date prochaine action</label>
