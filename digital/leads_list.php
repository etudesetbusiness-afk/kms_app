...
<div class="container-fluid">
    <div class="list-page-header d-flex justify-content-between align-items-center">
        <h1 class="list-page-title h3">
            ...
            Leads Digitaux
            <span class="count-badge ms-2"><?= count($leads) ?></span>
        </h1>
        <a href="<?= url_for('digital/leads_edit.php') ?>" class="btn btn-info btn-add-new">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-2">
            <div class="card stat-card border-warning">
                <div class="card-body p-3">
                    <div class="text-muted small mb-1">Nouveaux</div>
        ...
        <div class="col-md-2">
            <div class="card stat-card border-info">
                <div class="card-body p-3">
                    <div class="text-muted small mb-1">Contactés</div>
        ...
        <div class="col-md-2">
            <div class="card stat-card border-primary">
                <div class="card-body p-3">
                    <div class="text-muted small mb-1">Qualifiés</div>
        ...
        <div class="col-md-2">
            <div class="card stat-card border-success">
                <div class="card-body p-3">
                    <div class="text-muted small mb-1">Convertis</div>
        ...
        <div class="card-body">
            <form method="get" class="row g-3">
                ...
                <div class="col-md-1 d-flex align-items-end">
                    <button type="submit" class="btn btn-sm btn-filter w-100">
