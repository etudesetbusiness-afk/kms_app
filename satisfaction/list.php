...
<div class="container-fluid">
    ...
    <div class="list-page-header d-flex justify-content-between align-items-center">
        <h1 class="list-page-title h3">
            ...
            <span class="count-badge ms-2"><?= (int)$stats['total_enquetes'] ?></span>
        </h1>
    </div>
        ...
        <div class="card-body">
            <form class="row g-2 align-items-end" method="get">
                ...
                <div class="col-md-3 d-flex gap-2 mt-3 mt-md-0">
                    ...
                    <a href="<?= url_for('satisfaction/list.php') ?>" class="btn btn-outline-secondary btn-filter">
                        Réinitialiser
                    </a>
                </div>
            </form>
